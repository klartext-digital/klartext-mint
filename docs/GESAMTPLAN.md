# klartext digital — Gesamtplan und tatsächlicher Stand

Stand: 16. September 2026. Arbeitsgrundlage: ursprünglicher 90-Tage-Plan und die im Gespräch präzisierte Positionierung. Ein veröffentlichter Entwurf ist noch keine indexierte oder nachweislich erfolgreiche Seite.
...
| Authority / PR | Studienmethodik und Verteilungsschritte vorbereitet | Stichprobe erheben, Daten auswerten, fachlich prüfen, danach externe Ansprache ausdrücklich beauftragen |
...
KMU-Website-Report nach `STUDIENMETHODIK.md` erheben. Danach daraus Fachbeiträge, LinkedIn-Inhalte, Newsletter und konkrete Medienansätze entwickeln. Keine Statistik vorwegnehmen. Keine Kontakte anschreiben oder Posts veröffentlichen ohne entsprechenden Auftrag.

## Messgrössen statt Versprechen

- Technische Qualität: erreichbare freigegebene URLs, korrekte Weiterleitungen, gültige Metadaten, funktionierende Anfragezustellung.
- Sichtbarkeit: indexierte Seiten, relevante Suchanfragen, Impressionen und Klicks pro Themencluster.
- Geschäft: eingegangene und qualifizierte Anfragen, Gespräche und Aufträge nach Angebotstyp.
- Autorität: passende externe Erwähnungen, verweisende Domains und Nutzung der Originalrecherche.

Die früher genannten 15–25 Seiten/Referring Domains und Top-5-Ziele sind Ziele, keine erzielten Ergebnisse oder Garantien. Ein 90-Tage-Projekt enthält Datensammlung und spätere Auswertung; es ist nicht mit diesem Veröffentlichungsstand abgeschlossen.
